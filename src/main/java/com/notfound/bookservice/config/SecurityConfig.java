    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.OPTIONS, "/**")
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/books/batch")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/books/batch-details")
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/books/validate-ids")
                        .permitAll()
